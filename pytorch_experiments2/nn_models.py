...
class BoixNet(nn.Module):
    ...
    def __init__(self, nb_filters1,nb_filters2, kernel_size1,kernel_size2, nb_units_fc1,nb_units_fc2,nb_units_fc3):
        ...
        self.HW1 = nb_filters2*kernel_size2*kernel_size2
        self.fc1 = nn.Linear(self.HW1, nb_units_fc1)
    ...
    def forward(self, x):
        ...
        a_conv2 = F.relu(self.conv2(x))
        a_flat_conv2 = a_conv2.view(-1,self.HW1)
        ''' FC layers '''
