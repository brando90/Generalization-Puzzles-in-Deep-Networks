...
class Normalizer:
    ...
    def extract_all_results_vs_test_errors(self,path_all_expts,list_names,target_loss):
        for name in list_names:
            ...
            ''' extend results ''' #
            self.train_all_losses.extend(results.train_losses)
            self.gen_all_errors.extend(results.gen_errors)
        return self.train_all_losses, self.gen_all_errors
    ...
    def extract_results_with_target_loss(self,path_to_folder_expts,target_loss):
        ...
        results = NamedDict(train_losses=train_losses, gen_errors=gen_errors)
        return results
...
def main():
    ...
    ''' plot '''
    plt.plot(train_all_losses,gen_all_errors)
    plt.show()
