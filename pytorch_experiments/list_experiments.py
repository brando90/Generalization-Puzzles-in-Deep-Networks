...
def experiment_BigInits_MNIST():
    ...
    list_names.append('flatness_July_label_corrupt_prob_0.0_exptlabel_NL_24_units_2_layers_only_1st_layer_BIAS_True_data_set_mnist_reg_param_0.0_means_[0,0,0]_stds_[0.075,0.075,0.075]_batch_size_train_1024_lr_0.01_momentum_0.9_epochs_600')
    list_names.append('flatness_July_label_corrupt_prob_0.0_exptlabel_NL_24_units_2_layers_only_1st_layer_BIAS_True_data_set_mnist_reg_param_0.0_means_[0,0,0]_stds_[0.1,0.1,0.1]_batch_size_train_1024_lr_0.01_momentum_0.9_epochs_600')
    list_names.append('flatness_July_label_corrupt_prob_0.0_exptlabel_NL_24_units_2_layers_only_1st_layer_BIAS_True_data_set_mnist_reg_param_0.0_means_[0,0,0]_stds_[0.15,0.15,0.15]_batch_size_train_1024_lr_0.01_momentum_0.9_epochs_600')
    list_names.append('flatness_July_label_corrupt_prob_0.0_exptlabel_NL_24_units_2_layers_only_1st_layer_BIAS_True_data_set_mnist_reg_param_0.0_means_[0,0,0]_stds_[0.18,0.18,0.18]_batch_size_train_1024_lr_0.01_momentum_0.9_epochs_600')
    list_names.append('flatness_July_label_corrupt_prob_0.0_exptlabel_NL_24_units_2_layers_only_1st_layer_BIAS_True_data_set_mnist_reg_param_0.0_means_[0,0,0]_stds_[0.19,0.19,0.19]_batch_size_train_1024_lr_0.01_momentum_0.9_epochs_600')
    list_names.append('flatness_July_label_corrupt_prob_0.0_exptlabel_NL_24_units_2_layers_only_1st_layer_BIAS_True_data_set_mnist_reg_param_0.0_means_[0,0,0]_stds_[0.2,0.2,0.2]_batch_size_train_1024_lr_0.01_momentum_0.9_epochs_600')
    list_names.append('')
